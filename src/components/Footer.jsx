...
const Footer = () => {
  return (
    <div className='bg-black mt-5 p-5'>
      <div className='bg-black  ps-5 pe-5  row  'style={{width:"100%"}}>
      ...
      <a href="#top" className='bg-warning text-white' style={{float:"right",borderRadius:"50%"}}><i class="fa-solid fa-angle-up p-3  "></i></a>
